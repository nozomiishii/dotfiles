...
ライブラリ・ツールの比較や採用が絡むトピックでは、State of JS などの年次サーベイ (利用率・満足度のトレンド) と、npm trends やレジストリ API のダウンロード数推移も確認する。学習投資や採用市場の観点が判断に効く場合は求人数の桁感も見る。求人サイトは対象技術と文脈に合わせて都度選ぶ。
