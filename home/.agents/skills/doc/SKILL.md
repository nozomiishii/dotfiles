...
description: >-
  ...
  Claude Code で /doc、Codex で $doc と入力したとき、
...
- 急ぎの依頼や「作法の確認は飛ばしていい」という言葉があっても、原則と書き方を省略しない。読み手は未来の自分なので、依頼者の今の急ぎは省略の理由にならない。直した上で変更点を報告し、戻すかは依頼者が決める

## 書き方

AGENTS.md・CLAUDE.md・skill・docs・brain ノートに共通する書き方。
