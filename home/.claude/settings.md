...
- PR タイトルの検証は `home/.local/bin/gh` のシムが担う。判断の記録は [ADR](https://github.com/nozomiishii/dotfiles/blob/main/docs/decisions/PR%20タイトル検証は%20PreToolUse%20フックではなく%20gh%20シムで行う.md) にある
